...
public class UserService {
    ...
    public void updatePlayer(String username, PlayerDetails playerDetails) {
        Players existingPlayer = StreamSupport.stream(playerRepositry.findAll().spliterator(), false)
        ...
        existingPlayer.setSecondname(playerDetails.getSecondname());
        existingPlayer.setNic(playerDetails.getNic());
        existingPlayer.setQuizmark(playerDetails.getQuizmark());
        existingPlayer.setQuiztaken(playerDetails.getQuiztaken());

        playerRepositry.save(existingPlayer);
    }
